    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div class="lg:col-span-7">
            <section class="bg-surface-container-lowest p-5 sm:p-6 rounded-xl shadow-sm" x-show="santriData">
                ...
                <form action="{{ route('petugas.transactions.topup.store') }}" method="POST" class="space-y-6">
                    @csrf
...
function topUpForm(initialNis = '') {
    return {
        ...
        autoSearch() {
            ...
            // Auto-submit after 350ms of no typing
        ...
        async cariSantri(autoSelectExact = false) {
            ...
            try {
                const response = await fetch('{{ route("petugas.transactions.search-santri") }}', {
                    method: 'POST',
                    headers: {
